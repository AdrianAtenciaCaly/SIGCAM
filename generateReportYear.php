...
$box = findAllBoxYear('box', $p_year);

if (!$box) {
	$session->msg("d", "No hay registros con el año : $p_year");
	redirect('yearReport');
}
...
$output .= '
	...
	<table width="100%" cellpadding="5" border="1">
	<tr>
	<td colspan="2" align="center" style="font-size:18px">REPORTE POR AÑOS: ' . $p_year . '</td>
	</tr>
	</table>
